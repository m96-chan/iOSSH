// Standard row/column encoding values from the Kitty graphics protocol:
// https://github.com/kovidgoyal/kitty/blob/master/gen/rowcolumn-diacritics.txt
// These are protocol data (Unicode scalar values), not a Unicode width algorithm.
enum KittyDiacritics {
    ...
    static let indices = Dictionary(uniqueKeysWithValues: values.enumerated().map { ($0.element, $0.offset) })
}
